    ...
    <div className="app-shell">
      ...
      <main className="main-area">
        ...
        {loading ? <Loading/> : <>
          ...
          {page === "contactos" && <Contacts leads={data.leads} moveLead={moveLead} updateLead={updateLead} updateLeadOwner={updateLeadOwner} deleteLead={deleteLead} onAdd={() => setAddOpen(true)}/>}
...
function Contacts({ leads, moveLead, updateLead, updateLeadOwner, deleteLead, onAdd }: { leads: Lead[]; moveLead:(id:string,status:string)=>void; updateLead:(id:string,lead:Partial<Lead>)=>Promise<void>; updateLeadOwner:(ids:string[],owner:string)=>void; deleteLead:(id:string)=>void; onAdd:()=>void }) {
